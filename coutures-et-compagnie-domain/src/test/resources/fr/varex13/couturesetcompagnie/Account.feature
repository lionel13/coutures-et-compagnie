Feature: Gestion des élèves
  ...
  Un administrateur veut gérer les élèves

  Background:
    Given des administrateurs existent:
      | id                                   | firstName | lastName |
      | 6c5cfbac-a4fd-47ae-bac9-c01107280d0d | Shannon   | Knowles  |
      | d77b2939-857e-4d66-a205-13c090f223b8 | Mack      | Navarro  |
  ...
  Scenario Outline: Lister les élèves
